...
describe('CustomerOrder routing resolve service', () => {
  ...
  let routingResolveService: CustomerOrderRoutingResolveService;
  let service: CustomerOrderService;
  let resultCustomerOrder: ICustomerOrder | undefined;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(CustomerOrderRoutingResolveService);
  ...
  describe('resolve', () => {
    ...
    it('should return new ICustomerOrder if id is not provided', () => {
      // GIVEN
      ...
      expect(resultCustomerOrder).toEqual(new CustomerOrder());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as CustomerOrder })));
      mockActivatedRouteSnapshot.params = { id: 123 };
